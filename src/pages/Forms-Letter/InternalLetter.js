...
//api
import InternalLetterApi from "../../api/user/letter/InternalLetter"
...
function InternalLetters() {
  ...
  const getInboxList = async () => {
    const response = await InternalLetterApi(token)
  ...
  return !loading ? (
    <div className="page-content">
      ...
      <div className="container-fluid">
        <Breadcrumbs title="نامه ها" breadcrumbItem="نامه‌های داخلی" />
