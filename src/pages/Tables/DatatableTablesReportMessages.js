...
function DatatableReportMessages() {
  ...
  //meta title
  document.title = "گزارشات پیام - سامانه مکاتبات"
  ...
  return !loading ? (
    <div className="page-content">
      ...
      <div className="container-fluid">
        <Breadcrumbs title="گزارشات" breadcrumbItem="پیام ها" />
...
DatatableReportMessages.propTypes = {
  preGlobalFilteredRows: PropTypes.any,
}

export default DatatableReportMessages
