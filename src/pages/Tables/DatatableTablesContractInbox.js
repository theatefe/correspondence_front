...
function DatatableVacationInbox() {
  ...
  const getInboxList = () => {
    ...
    fetch(`http://localhost:3000/form/inbox-contract/`, config)
            ...
            <li>
              ...
              >
                <Link to={`#`} className="btn btn-soft-primary">
                  {/* <Link to={`/contract-detail/${cell.value}`} className="btn btn-soft-primary"> */}
                  <i
  ...
  //meta title
  document.title = "پیگیری ‌قراردادها- سامانه مکاتبات"
  ...
  return !loading ? (
    <div className="page-content">
      <div className="container-fluid">
        <Breadcrumbs
          title="فرم های ورودی"
          breadcrumbItem="درخواست های قرارداد"
        />
