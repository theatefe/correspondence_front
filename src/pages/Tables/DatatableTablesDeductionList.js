...
function DatatableDeductionList() {
  ...
  const getInboxList = () => {
    ...
    fetch(`http://localhost:3000/form/outbox-deduction/`, config)
  ...
  return !loading ? (
    <div className="page-content">
      <div className="container-fluid">
        <Breadcrumbs
          title="فرم های خروجی"
          breadcrumbItem="گواهی های کسرازحقوق"
        />
...
DatatableDeductionList.propTypes = {
  preGlobalFilteredRows: PropTypes.any,
}

export default DatatableDeductionList
