...
function DatatableVacationList() {
  ...
  const getInboxList = () => {
    ...
    fetch(`http://localhost:3000/form/outbox-vacation/`, config)
  ...
  //meta title
  document.title = "فرم‌های مرخصی - سامانه مکاتبات"

  return !loading ? (
    <div className="page-content">
      <div className="container-fluid">
        <Breadcrumbs title="فرم های خروجی" breadcrumbItem="درخواست های مرخصی" />
